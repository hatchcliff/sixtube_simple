...
// possible to set up.  Date and time functions and an automatic cathode cleaning cycle are provided, but
// there are no alarm functions, and no run-time selectable options.
//
